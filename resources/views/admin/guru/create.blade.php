...
<div class="max-w-3xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between">
        ...
        <span class="text-xs font-bold text-slate-400">Registrasi Fungsionaris</span>
    </div>
    ...
    <div class="bg-white border border-slate-100 rounded-2xl shadow-sm overflow-hidden">
        ...
        <div class="p-6 border-b border-slate-50 bg-slate-50/50 flex items-center space-x-3">
            ...
            <div>
                <h2 class="text-base font-black text-slate-800 tracking-tight">Registrasi Guru Baru</h2>
                <p class="text-[11px] text-slate-400">Buatkan akun akses sistem absensi digital untuk tenaga pengajar baru di SDN 118198 Sei Piandang.</p>
            </div>
        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div class="space-y-1.5">
                        ...
                        <div class="relative">
                            ...
                            <input type="email" name="email" required placeholder="budi@sekolah.id"
                                   class="w-full bg-slate-50/50 border border-slate-200 text-slate-800 py-2.5 pl-10 pr-4 rounded-xl text-xs font-bold placeholder:text-slate-400 placeholder:font-medium focus:outline-none focus:bg-white focus:border-[#362219] focus:ring-4 focus:ring-[#362219]/5 transition-all">
                        </div>
                    </div>

                    <div class="space-y-1.5">
                        <label class="text-xs font-bold text-slate-500 uppercase tracking-wider block">Kata Sandi Akses (Password)</label>
                        <div class="relative">
