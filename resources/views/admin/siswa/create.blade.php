...
<div class="max-w-3xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between">
        ...
        <span class="text-xs font-bold text-slate-400">Formulir Registrasi</span>
    </div>
    ...
    <div class="bg-white border border-slate-100 rounded-2xl shadow-sm overflow-hidden">
        ...
        <div class="p-6 border-b border-slate-50 bg-slate-50/50 flex items-center space-x-3">
            ...
            <div>
                <h2 class="text-base font-black text-slate-800 tracking-tight">Registrasi Siswa Baru</h2>
                <p class="text-[11px] text-slate-400">Tambahkan data siswa dan tautkan dengan akun orang tua di SDN 118198 Sei Piandang.</p>
            </div>
        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="nis" required placeholder="Contoh: 235290"
